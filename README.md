...
このプロジェクトは npm パッケージとしては配布していません。**リポジトリをクローンして、自分の環境で使う**スタイルです。
...
Skills は利用者が自由に追加・編集していくものなので、リポジトリごと手元に持つ必要があります。
...
Claude Code でこのリポジトリを開くと、Agent Skills が自動で有効になります。
...
> 参考: [Vol.05 テクニカル指標の作成と評価](https://github.com/i-love-profit/crypto-data-analysis-course/blob/main/vol05_technical_indicators.ipynb)（前半）
...
> 参考: [Vol.04 リードラグ分析](https://github.com/i-love-profit/crypto-data-analysis-course/blob/main/vol04_lead_lag_analysis.ipynb)（リーク・コスト感度）+ 教材横断のリスク指標
...
> 参考: [Vol.02 リターン分布と出来高分布](https://github.com/i-love-profit/crypto-data-analysis-course/blob/main/vol02_return_and_volume_distribution.ipynb)
...
> 参考: [Vol.03 相関分析](https://github.com/i-love-profit/crypto-data-analysis-course/blob/main/vol03_correlation_analysis.ipynb) / [Vol.04 リードラグ分析](https://github.com/i-love-profit/crypto-data-analysis-course/blob/main/vol04_lead_lag_analysis.ipynb)（ラグ・安定性）
...
> 参考: [Vol.01 データ取得とクレンジング](https://github.com/i-love-profit/crypto-data-analysis-course/blob/main/vol01_data_acquisition_and_cleansing.ipynb)
...
いくつかの Skill は hoheto 氏の学習教材 [crypto-data-analysis-course](https://github.com/i-love-profit/crypto-data-analysis-course) を参考にして作成しました。各 Skill の対応 Vol は上記の「参考」リンクを参照してください。素晴らしい教材を公開してくださっていることに感謝いたします。
